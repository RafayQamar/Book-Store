...
if(theme === "dark"){
  ...
  return (
   <>
   <div 
   className={' max-wscreen-2x1 container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50'}>
  ...
  <label class=" px-3 py-1 border rounded-md flex items-center gap-2">
